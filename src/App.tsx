        ...
        {activeTab === 'about' && (
          <div className="space-y-6">
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold mb-4">About MIDIFlow</h2>
              
              <div className="space-y-4 text-gray-300">
                <p>
                  MIDIFlow is a focused web-based tin whistle practice application that provides 
                  real-time visual feedback through MIDI input. Practice songs with step-by-step 
                  guidance and see your progress in real-time.
                </p>
                ...
                <div className="bg-gray-700 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center space-x-2">
                      ...
                      <span>Real-time MIDI input with visual feedback</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <span className="text-green-400">✓</span>
                      <span>Sequential practice mode with timing</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <span className="text-green-400">✓</span>
                      <span>MIDI file import and track selection</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <span className="text-green-400">✓</span>
                      <span>Built-in tin whistle fingering charts</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <span className="text-green-400">✓</span>
                      <span>Adjustable practice tempo (25%-100%)</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <span className="text-green-400">✓</span>
                      <span>Song storage and management</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gray-700 rounded-lg p-4">
                  ...
                  <a
                    href="https://github.com/Coriakin/midiflow"
                    target="_blank"
